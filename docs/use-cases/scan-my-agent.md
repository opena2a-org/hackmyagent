...
This runs all 163 checks against your current directory. No config files or setup needed.
...
Checks:  163 across 30 categories
Time:    2.4s
...
- Use `--verbose` to see all 163 checks, including ones that passed.
...
- See the full [Security Checks Reference](../SECURITY_CHECKS.md) for all 163 checks
