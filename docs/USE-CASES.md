# HackMyAgent Use Cases

Guided walkthroughs for common security workflows.

| Use Case | Time | Description |
|----------|------|-------------|
| [Scan My Agent](use-cases/scan-my-agent.md) | 5 min | Run all 163 security checks and auto-fix findings |
...
Each guide includes the exact commands to run, expected output, and next steps.
